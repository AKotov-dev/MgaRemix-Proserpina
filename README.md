...
**Объявление**: Как и годом ранее... Снова собираемся у озера, далеко от цивилизации (июнь-июль).

Как и в прошлом году — лес, палатки, костёр, разговоры, код и ночные споры ни о чём и обо всём сразу.  
  
**Например:** Почему sing-box не повторяет поведения нативного NaiveBox и гоняет UDP даже сквозь quick=false. И почему Proserpina решает проблему через type=http. Вот это баг так баг... ))) Обсуждаем... При луне...  
  
Девушки готовят закуски.. Мы готовим решения.. И ловим рыбу...  Запускаем салюты... Избегаем публичности... Не исследуем чужую сущьность. )))

https://www.youtube.com/watch?v=SegabkJ8HQ8

Жду, обдумайте... примите решение, не торопитесь.. Время есть... 
...
**Cтратегия, перспектива**
- Поддержка децентрализованных криптографических платёжных решений
- Переход на поисковые сервисы, ориентированные на защиту приватности пользователей
- Усиление приватности системы: анонимизация, шифрование хранилищ данных с использованием LUKS
...
![](https://github.com/AKotov-dev/MgaRemix-Proserpina/blob/main/png/chatgpt-plugin-36.png) **ChatGPT Plugin** — The customizable [launch button](https://github.com/AKotov-dev/chatgpt-plugin) for quick access to [ChatGPT (Official)](https://chatgpt.com/)

...
![](https://github.com/AKotov-dev/MgaRemix-Proserpina/blob/main/AmneziaVPN-100.png) **MgaRemix-Proserpina** received a multi-protocol VPN client [AmneziaVPN](https://github.com/AKotov-dev/AmneziaOnMageia). In addition to support for multiple protocols (including WARP/AmneziaWG), you can now create a VPN on your own server with [high privacy requirements](https://amnezia.org/ru/self-hosted).

...
**Примечание**: В особо запущенных случаях рекоммендуется юзать привычный [Juggler (Mageia only)](https://github.com/AKotov-dev/juggler), поскольку использовать уже заблокированные VPN гораздо удобнее, чем открывать те, которые будут заблокированы. ProtonVPN, ZoogVPN и т.д. до сих пор работают. Чем больше блокируют, тем больше интерпретаций протоколов. Это даже интересно, пока в РКН работают бездарности.

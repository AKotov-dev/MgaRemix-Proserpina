...
![](https://github.com/AKotov-dev/MgaRemix-Proserpina/blob/main/AmneziaVPN-64.png) **MgaRemix-Proserpina** received a multi-protocol VPN client [AmneziaVPN](https://github.com/AKotov-dev/AmneziaOnMageia). In addition to support for multiple protocols (including `WARP/AmneziaWG`), you can now create a [high-privacy VPN](https://amnezia.org/en/self-hosted) on your own server. Minimum server [requirements and installation](https://amnezia.org/en/starter-guide) sequence.

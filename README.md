...
**UPD [130625]** В следующем обновлении **Proserpina** прощается с российским аналогом [ChatGPT](https://gpt-open.ru/): нестабильная работа, узкие рамки и творческий подход к "бесплатности" не соответствуют духу нашего проекта. Рекомендуем использовать настоящий [ChatGPT](https://chatgpt.com/) — он обеспечивает открытый диалог и высокое качество ответов, на которые ориентирован проект. Альтернативы пока не могут полноценно заменить этот опыт.

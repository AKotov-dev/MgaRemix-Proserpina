...
**Примечание:** [Juggler](https://github.com/AKotov-dev/juggler) предназначен для смены сочетаний (дальнейших инкапсуляций) протоколов, поэтому `ProtonVPN` или `ZoogVPN` работают до сих пор. Именно поэтому в России рекомендуеться использовать **уже заблокированные** протоколы. В РКН нет компетентных специалистов, поэтому ближайшая цель - блокировка всех известных протоколов.   

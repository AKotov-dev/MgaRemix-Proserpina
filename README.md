...
**Например:** Отсутствие UPD/QUIC sing-box в режиме NaiveProxy... Почему sing-box не повторяет поведения нативного NaiveBox и гоняет UDP даже сквозь quick=false. И почему Proserpina решает проблему через type=http. Вот это баг так баг... ))) Обсуждаем... При луне...  
  
Девушки готовят закуски.. Мы готовим решения.. ;

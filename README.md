...
**Примечание**: В особо запущенных случаях рекоммендуется юзать привычный [Juggler](https://github.com/AKotov-dev/juggler), поскольку использовать уже заблокированные VPN гораздо удобнее, чем открывать те, которые будут заблокированы. ProtonVPV, ZoogVPN и т.д.

...
![](https://github.com/AKotov-dev/MgaRemix-Proserpina/blob/main/santa-64.png) _Ввиду того, что Прозерпина и так перенасыщена цифровым оружием, которое многим не нужно, было принято решение на 2 ближайших месяца оставить всё без изменений. Отдыхайте... Мир Вашему Дому.. Поздравьте с наступающим родных и близких._

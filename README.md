...
**Объявление**: Как и голом ранее... Снова собираемся у озера, далеко от цивилизации (июнь-июль).Как и в прошлом году — лес, палатки, костёр, разговоры, код и ночные споры ни о чём и обо всём сразу.  
  
Например: Отсутствие UPD/QUIC sing-box в режиме NaiveBox... Почему sing-box не повторяет поведения нативного NaiveBox и гоняет UDP даже сквозь quick=false. И почему Proserpina решает проблему через type=http. Вот это баг так баг... ))) Обсуждаем... При луне... Девушки готовят закуски.. Мы готовим решения.. ;

...
**Примечание**: В особо запущенных случаях рекоммендуется юзать привычный [Juggler (Mageia only)](https://github.com/AKotov-dev/juggler), поскольку использовать уже заблокированные VPN гораздо удобнее, чем открывать те, которые будут заблокированы. ProtonVPN, ZoogVPN и т.д. до сих пор работают. Чем больше блокируют, тем больше интерпретаций протоколов. Цель - заблокировать все популярные протоколы. Ну а за ними последуют менее популярные и т.д. https://www.youtube.com/watch?v=5IkFiuIkcPI История Рима, как и любой империи завершается пылью её воинов.

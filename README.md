...
**Личное впечатление о Mageia-10_alpha1:** [Плохой Санта](https://www.youtube.com/watch?v=TBVr5qJSw4U)... Надеюсь к `beta` поправят Nemo. Но виноват конечно же апстрим... )) MATE - забрать свежий релиз не позволяет религия, поскольку разработчик упёртый чувак `mate-screenshot`... Поэтому ещё года два будет и пакет с глюками... [nemo-engrampa](https://github.com/AKotov-dev/budgie-desktop-rpm/blob/main/nemo-engrampa-rpm-m10.tar.gz) - GTK4 на поводу у принципиальных парней из конторы, которая уже давно в глубокой яме со своими принципами. Открою вам секрет: MATE и GNOME - это пара голубых, которые уверены, что задают какие-то стандарты среди голубых.  )))) И мы этим пользуемся?! ))) Да... Мы этим пользуемся... Этим дерьмом... 

Это субъективная точка зрения... Вы в праве с этим не соглашаться... Но факт остаётся фактом... Люблим то, что запрещено, продвигаем то, что достойно нормальных, умных людей. Когда же придёт это самое [спокойствие](https://www.youtube.com/watch?v=YIGgltRGtqU). Наверное никогда.

Если оно придёт, спокойствие - значит не будет движения. А движение быть должно. Его не может не быть.

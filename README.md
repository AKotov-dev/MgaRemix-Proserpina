...
**Например:** Почему sing-box не повторяет поведения нативного NaiveBox и гоняет UDP даже сквозь quic=false. И почему Proserpina решает проблему через type=http. Вот это баг так баг... ))) Обсуждаем... При луне...  
